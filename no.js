...
*/
let index = 7;
let problem9 = myFavoriteNumbers[index];
...
// 'problem9' to the value of the 7th element in the array.
  while(problem9===undefined)
  {
    myFavoriteNumbers.push(myFavoriteNumbers[myFavoriteNumbers.length - 1] + 4);
    problem9 = myFavoriteNumbers[index]; //weird that you have to do this again
  }
...
for(var k=0; k<listOfNumbers.length; k++)
{
  ...
  {
    console.log(listOfNumbers[k] + " is divisible by three.");
  }
  else
  {
    console.log(listOfNumbers[k] + " is not divisible by three.");
  }
}
...
for(let h = letters.length-1; h>=0; h--)
{
...
////////// PROBLEM 14 //////////
// Switch statements can be excellent alternatives to look up a switch statement (I recommend W3 Schools) and try to implement one
// in the following.
